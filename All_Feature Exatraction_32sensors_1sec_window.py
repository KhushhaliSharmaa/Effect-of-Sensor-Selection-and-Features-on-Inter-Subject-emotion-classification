            ...
            for k in range(nTrial):
                ...
                for K in range(np.shape(C_EEG_Trial[:,1])[0]):
                    # Filtering
                      ...
                      filtered_theta = scipy.signal.lfilter(b_theta, a_theta, C_EEG_Trial[0:32,:], axis = 0)
                      ...
                      filtered_alpha = scipy.signal.lfilter(b_alpha, a_alpha, C_EEG_Trial[0:32,:], axis = 0)
...
np.save('all_feat_32sensor.npy',Feature_chunk)
