...
for i in range(no_of_users):  # nUser  #4, 40, 32, 40, 8064
    ...
    if (i % 1 == 0):
        ...
        for k in range(nTrial):
            ...
            # C_EEG_Trial = Ctrial[0:10, 4224:8064] #3sec baseline removal
            ...
            Feature_array.append(
                [Skew_Value, Kurt_Value, Ent_Value, HFD_Value, Corr_Value, bp_gamma_Value, bp_theta_Value,
                 bp_alpha_Value, bp_beta_Value])
...
np.save('all_feat_5sensor.npy',Feature_chunk)